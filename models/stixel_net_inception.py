...
def build_stixel_net(input_shape=(1280, 1920, 3)):
    ...
    x = layers.MaxPooling2D((3, 3), strides=(2, 2), name="block1_pool", padding='same')(x)
    x = layers.Conv2D(192, (3, 3), activation="relu", strides=(2, 1), padding='same')(x)
    ...
    x = layers.MaxPooling2D((3, 3), strides=(2, 2), name="block2_pool", padding="same")(x)
    ...
    x = layers.MaxPooling2D((3, 3), strides=(2, 2), name="block3_pool", padding="same")(x)

    x = inception_module(x, 256, 160, 320, 32, 128, 128)

    x = inception_module(x, 384, 192, 384, 48, 128, 128)

    x = layers.MaxPooling2D((7, 7), strides=(1, 1), name="block4_pool", padding="same")(x)

    x = layers.Dropout(0.4)(x)

    x = layers.Conv2D(2048, (1, 1), activation="relu", strides=(1, 1), padding="same")(x)
    x = layers.MaxPooling2D((3, 3), strides=(3, 1), name="block5_pool", padding="same")(x)
    x = layers.Conv2D(2048, (1, 1), activation="relu", strides=(1, 1), padding="same")(x)
    x = layers.MaxPooling2D((3, 3), strides=(3, 1), name="block6_pool", padding="same")(x)
    x = layers.Conv2D(2048, (1, 1), activation="relu", strides=(1, 1), padding="same")(x)
    x = layers.MaxPooling2D((3, 3), strides=(3, 1), name="block7_pool", padding="same")(x)
    x = layers.Conv2D(2048, (1, 1), activation="relu", strides=(1, 1), padding="same")(x)
    x = layers.MaxPooling2D((3, 3), strides=(3, 1), name="block8_pool", padding="same")(x)

    x = layers.Conv2D(160, (1, 1), strides=(1, 1), activation="softmax", padding="same")(x)
    # summarize model
